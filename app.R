...
# ## duplikat für weiteres reactive Binding
# 
# edges_prob <- edges
# 
# ## duplikat für weiteres reactive Binding
...
# nodes_prob <- nodes 
# 
# ## initialisierung für quant_analyse wähle szenario
# 
...
# saveRDS(edges_prob, "edges_prob.rds")
# saveRDS(nodes_prob, "nodes_prob.rds")
# saveRDS(nodes_initial_scenarios, "nodes_initial_scenarios.rds")
...
dummy <- 0
# "double-bounce", "circle", "bounce", "folding-cube",
